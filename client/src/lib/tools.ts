...
export const tools: ToolDefinition[] = [
  ...
  { id: "pdf-to-img", name: "PDF to Image", description: "Convert PDF pages to image files", icon: "Image", category: "convert", color: "bg-teal-500/10 text-teal-600 dark:text-teal-400", route: "/tool/pdf-to-img", acceptedTypes: [".pdf"], multiple: false, processingMode: "browser-main" },
  { id: "pdf-to-images", name: "PDF to Images Pro", description: "Choose pages, format, resolution, and JPG quality", icon: "Image", category: "convert", color: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400", route: "/tool/pdf-to-images", acceptedTypes: [".pdf"], multiple: false, processingMode: "browser-main" },
  { id: "html-to-pdf", name: "HTML File to PDF", description: "Prepare a safe local HTML preview for saving as PDF", icon: "Globe", category: "convert", color: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400", route: "/tool/html-to-pdf", acceptedTypes: [".html", ".htm"], multiple: false, processingMode: "browser-main" },
  { id: "sign-pdf", name: "Sign PDF", description: "Draw or upload your signature to sign a PDF", icon: "PenTool", category: "edit", color: "bg-fuchsia-500/10 text-fuchsia-600 dark:text-fuchsia-400", route: "/tool/sign-pdf", acceptedTypes: [".pdf"], multiple: false, processingMode: "browser-main" },
  ...
  { id: "protect", name: "Protect PDF", description: "Add password protection to your PDF", icon: "Lock", category: "security", color: "bg-red-500/10 text-red-600 dark:text-red-400", route: "/tool/protect", acceptedTypes: [".pdf"], multiple: false, processingMode: "browser-wasm" },
  { id: "unlock", name: "Unlock PDF", description: "Remove password from a protected PDF", icon: "Unlock", category: "security", color: "bg-green-500/10 text-green-600 dark:text-green-400", route: "/tool/unlock", acceptedTypes: [".pdf"], multiple: false, processingMode: "browser-wasm" },
  { id: "compress-image", name: "Compress Image", description: "Compress JPG, PNG, or WebP with best quality", icon: "Minimize2", category: "image", color: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400", route: "/tool/compress-image", acceptedTypes: [".jpg", ".jpeg", ".png", ".webp"], multiple: false, processingMode: "browser-main" },
  { id: "resize-image", name: "Resize Image", description: "Change the pixel dimensions of your image", icon: "Image", category: "image", color: "bg-blue-500/10 text-blue-600 dark:text-blue-400", route: "/tool/resize-image", acceptedTypes: [".jpg", ".jpeg", ".png", ".webp"], multiple: false, processingMode: "browser-main" },
  { id: "crop-image", name: "Crop Image", description: "Crop and trim your image", icon: "Scissors", category: "image", color: "bg-orange-500/10 text-orange-600 dark:text-orange-400", route: "/tool/crop-image", acceptedTypes: [".jpg", ".jpeg", ".png", ".webp"], multiple: false, processingMode: "browser-main" },
  { id: "rotate-image", name: "Rotate Image", description: "Rotate your images 90, 180 or 270 degrees", icon: "RotateCw", category: "image", color: "bg-purple-500/10 text-purple-600 dark:text-purple-400", route: "/tool/rotate-image", acceptedTypes: [".jpg", ".jpeg", ".png", ".webp"], multiple: false, processingMode: "browser-main" },
  { id: "watermark-image", name: "Watermark Image", description: "Stamp an image or text over your images", icon: "Droplets", category: "image", color: "bg-cyan-500/10 text-cyan-600 dark:text-cyan-400", route: "/tool/watermark-image", acceptedTypes: [".jpg", ".jpeg", ".png", ".webp"], multiple: false, processingMode: "browser-main" },
];
